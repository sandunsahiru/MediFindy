              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      // autogroupkplwfy9 (Kjocyjsa3WWPBWQV7dkpLw)
                      padding: EdgeInsets.fromLTRB(
                          15 * fem, 5 * fem, 26 * fem, 6 * fem),
                      width: double.infinity,
                      decoration: BoxDecoration(
                        color: Color(0xffd9d9d9),
                        borderRadius: BorderRadius.circular(10 * fem),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      // autogroupek2orXq (Kjod9ekip7icndtoyPEK2o)
                      padding: EdgeInsets.fromLTRB(
                          16 * fem, 6 * fem, 22 * fem, 5 * fem),
                      width: double.infinity,
                      decoration: BoxDecoration(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      // autogroupjq19F4B (KjodHUs1VFYnZSkUkXjq19)
                      padding: EdgeInsets.fromLTRB(
