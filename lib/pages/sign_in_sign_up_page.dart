...
class SignInSignUpPage extends StatelessWidget {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildActionContainer(context, 'Pharmacy Admin',
                const PharmacyLoginPage(), width, height * 0.04),
            _buildActionContainer(
                context, 'User', const UserLoginPage(), width, height * 0.04),
            const Text(
              'Sign Up as a,',
              textAlign: TextAlign.center,
              style: TextStyle(
            ...
            _buildActionContainer(context, 'Pharmacy Admin',
                const PharmacySignUp(), width, height * 0.04),
            _buildActionContainer(
                context, 'User', const UserSignUpPage(), width, height * 0.04),
          ],
        ),
      ),
    );
  ...
  Widget _buildActionContainer(BuildContext context, String text, Widget page,
      double width, double containerHeight) {
